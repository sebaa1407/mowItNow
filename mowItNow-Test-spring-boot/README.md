...
## Conception
Ce projet se décompose
- <strong>model </strong>: fournie les classes des objets.
- <strong>Controller</strong>: les actions effectuées par l'utilisateur
- <strong>Exception</strong>: gestion des exceptions
- <strong>Tools</strong>: les interfaces et les implementations
- <strong>Tomplates</strong>: Une vue(View) contient la présentation de l'interface graphique.
...
* Langage de programmation: Java, spring ,boot thymeleaf
* Gestionnaire de source: Git 
* Gestionnaire de projet: Maven
* IDE: Eclipse  oxygen
* Serveur: Spring Boot  (tomcat)
* Tests: JUnit
